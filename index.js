...
//     const { userId, headerColor,headerBackColor,bubbleColor,message1,firstmessgae } = req.body;
//   console.log(userId,headerColor,headerBackColor,bubbleColor,message1,firstmessgae,"post")

//     try {
//       const customization = new UserCustomization({
//         userId: userId,
...
//       console.log('User customization created successfully');
//       res.status(201).json({ message: 'User customization created' });
//     } catch (error) {
//       console.error('Error creating user customization:', error);
//       res.status(500).json({ error: 'Failed to create user customization' });
//     }
//   });
